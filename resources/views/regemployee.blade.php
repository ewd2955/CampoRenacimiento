...
<script>
  ...
  <li class="nav-item ">
    <a class="nav-link active" style="color:purple;" href="/alta_empleado">Empleado</a>
  </li>
  <li class="nav-item">
...
<div class="row m-4 ">
    <form action="/alta_empleado" method="get" class="form-signin ">
...
?>
      ...
      <div class="mb-3">
        ...
        <input type="text" id="nombre" name="nombre" class="border-0 bg-light p-2" />  
      </div>

      <div class="mb-3">
        <label class="form-label" for="credito">Credito</label>
        <input type="text" id="credito" name="credito" class="border-0 bg-light p-2" />  
      </div>

      <div class="mb-3">
        <label class="form-label" for="obs">Observaciones</label>
        <textarea  id="obs" rows="4" name="obs"  class="border-0 bg-light p-2 w-100" placeholder="Notas medicas" /> </textarea> 
      </div>
     
    
      <!-- Submit button -->
        <button data-mdb-ripple-init type="submit"  class="form-control bg-light p-3">Registrar empleado</button>
    </form>
</div>
